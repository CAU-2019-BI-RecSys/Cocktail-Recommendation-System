...
export default {
    ...
    methods : {
        ...
        initMenus(){
            ...
            let currentObj = this
            let restaurant=''
            currentObj.axios.get('http://localhost:8000/api/userorder/'+this.order_id+'/')
                .then((result) => {
                    console.log(result.data)
            ...
            currentObj.axios.get('http://localhost:8000/api/ordercontents/0/?order_id='+this.order_id)
                .then((result) => {
                    console.log(result.data)
            ...
            setTimeout(() => {
                ...
                currentObj.axios
                    .get('http://localhost:8000/api/restrating/1/?restaurant_name='+restaurant.split('/')[5]+'&username='+username)
                    .then((result) => {
                ...
                for(let [index] in currentObj.ordermenus){
                    ...
                    currentObj.axios
                    .get('http://localhost:8000/api/menurating/1/?username='+username+'&menu_id='+menu_id)
                    .then((result) => {
